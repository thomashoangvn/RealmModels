...
public final class RealmModels {
    ...
    public typealias ErrorHandler = (_ realm: RealmModels, _ error: NSError, _ type: ErrorType) -> Void
    ...
    public func write(_ block: (() throws -> Void)) {
        do {
            ...
            RealmModels.handleError?(self, error as NSError, .write)
        }
    }
    ...
    public func writeCopy(toFile fileURL: URL, encryptionKey: Data? = nil) {
        do {
            ...
            RealmModels.handleError?(self, error as NSError, .encrypt)
        }
    }
...
extension RealmModels: Equatable { }

/// Returns whether the two realms are equal.
public func == (lhs: RealmModels, rhs: RealmModels) -> Bool { // swiftlint:disable:this valid_docs
...
public typealias NotificationBlock = (_ notification: Realm.Notification, _ realm: RealmModels) -> Void

// MARK: Unavailable

extension RealmModels {
